...
<div class="container">
	<div class="row">
		<div class="col-md-8 offset-md-2">
			<h1 class="text-muted text-center"> <i class="fa fa-edit"></i> Modificar mis datos </h1>
			<hr>
			<nav aria-label="breadcrumb">
			  <ol class="breadcrumb">
			  	<li class="breadcrumb-item"><a href="index.php" class="text-purple">Módulo Usuarios</a></li>
			    <li class="breadcrumb-item active">Modificar mis datos</li>
			  </ol>
			</nav>
			<?php $usu = modificarUsuario($con, $_GET['id']); ?>
